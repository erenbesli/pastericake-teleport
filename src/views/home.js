  ...
  return (
    <div className="home-container">
      ...
      <div className="section-container">
        ...
        <footer className="home-max-width7 max-content-container">
          <img alt="image" src="/logo1-200h.png" className="home-image6" />
          <span className="home-text65">
            ...
            <span className="home-text69">teleporhq.io</span>
            <span>
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
